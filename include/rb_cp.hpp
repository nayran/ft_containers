...
namespace ft
{
    ...
    template < class Key, class Value, class T = ft::pair< Key, Value >, class Compare = ft::less<T>, class s_Node = ft::s_Node<T>, class Alloc = std::allocator<s_Node> >
    class BTree
    {
        public:
			typedef Key								key_type;
            typedef T                               value_type;
            typedef s_Node                            node_type;
            typedef s_Node*                           node_pointer;
